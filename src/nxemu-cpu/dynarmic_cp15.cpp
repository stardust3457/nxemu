...
{
    LOG_CRITICAL(Core_ARM, "CP15: cdp{} p15, {}, {}, {}, {}, {}", two ? "2" : "", opc1, CRd, CRn, CRm, opc2);
    return std::nullopt;
}
...
#error Unsupported architecture
    ...
    LOG_CRITICAL(Core_ARM, "CP15: mcr{} p15, {}, <Rt>, {}, {}, {}", two ? "2" : "", opc1, CRn, CRm, opc2);
    return {};
}
                                                        ...
                                                        CoprocReg CRm, unsigned opc2)
{
    ...
    LOG_CRITICAL(Core_ARM, "CP15: mrc{} p15, {}, <Rt>, {}, {}, {}", two ? "2" : "", opc1, CRn, CRm, opc2);
    return {};
}
...
CallbackOrAccessTwoWords DynarmicCP15::CompileGetTwoWords(bool two, unsigned opc, CoprocReg CRm)
{
    if (!two && opc == 0 && CRm == CoprocReg::C14)
    {
        ...
        const auto callback = [](void * arg, u32, u32) -> u64 {
            ...
            return parent_arg.m_system.Timing().GetClockTicks();
        };
...
std::optional<Callback> DynarmicCP15::CompileLoadWords(bool two, bool long_transfer, CoprocReg CRd, std::optional<u8> option)
{
    if (option)
    {
        LOG_CRITICAL(Core_ARM, "CP15: mrrc{}{} p15, {}, [...], {}", two ? "2" : "", long_transfer ? "l" : "", CRd, *option);
    }
    else
    {
        LOG_CRITICAL(Core_ARM, "CP15: mrrc{}{} p15, {}, [...]", two ? "2" : "", long_transfer ? "l" : "", CRd);
    }
    return std::nullopt;
}
