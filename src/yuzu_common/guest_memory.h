...
public:
    GuestMemory() = delete;
    explicit GuestMemory(M & memory, u64 addr, std::size_t size, Common::ScratchBuffer<T> * backup = nullptr) :
        m_memory{memory},
        m_addr{addr},
        m_size{size}
    {
...
public:
    ...
    explicit GuestMemoryScoped(M & memory, u64 addr, std::size_t size, Common::ScratchBuffer<T> * backup = nullptr) :
