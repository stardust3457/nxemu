...
#include "yuzu_common/android/applets/software_keyboard.h"
...
void InitJNI(JNIEnv* env) {
    s_software_keyboard_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("org/nxemu/applets/keyboard/SoftwareKeyboard")));
    s_keyboard_config_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("org/nxemu/applets/keyboard/SoftwareKeyboard$KeyboardConfig")));
    s_keyboard_data_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("org/nxemu/applets/keyboard/SoftwareKeyboard$KeyboardData")));

    s_swkbd_execute_normal = env->GetStaticMethodID(
        s_software_keyboard_class, "executeNormal",
        "(Lorg/nxemu/applets/keyboard/SoftwareKeyboard$KeyboardConfig;)Lorg/nxemu/"
    ...
    s_swkbd_execute_inline = env->GetStaticMethodID(
        ...
        "(Lorg/nxemu/applets/keyboard/SoftwareKeyboard$KeyboardConfig;)V");
}
