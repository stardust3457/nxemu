...
Result TouchDriver::WaitForInput()
{
    ...
    for (std::size_t id = 0; id < MaxFingers; ++id)
    {
        ...
        if (id < active_fingers_count)
        {
            ...
            touch_entry.diameter_x = osSettings.touchscreen.diameter_x;
            touch_entry.diameter_y = osSettings.touchscreen.diameter_y;
            touch_entry.rotation_angle = osSettings.touchscreen.rotation_angle;
