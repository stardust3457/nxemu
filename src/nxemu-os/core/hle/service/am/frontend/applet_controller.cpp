...
void Controller::Initialize()
{
    ...
    ASSERT_MSG(controller_private_arg.arg_private_size == sizeof(ControllerSupportArgPrivate), "Unknown ControllerSupportArgPrivate revision={} with size={}", controller_applet_version, controller_private_arg.arg_private_size);
    ...
    if (controller_private_arg.mode >= ControllerSupportMode::MaxControllerSupportMode)
    {
        ...
        case sizeof(ControllerKeyRemappingArg):
            ...
            break;
        default:
            UNIMPLEMENTED_MSG("Unknown ControllerPrivateArg mode={} with arg_size={}", controller_private_arg.mode, controller_private_arg.arg_size);
            controller_private_arg.mode = ControllerSupportMode::ShowControllerSupport;
            break;
        }
    }
    ...
    case ControllerSupportMode::ShowControllerStrapGuide:
    {
        ...
        case ControllerAppletVersion::Version8:
            ...
            break;
        default:
            UNIMPLEMENTED_MSG("Unknown ControllerSupportArg revision={} with size={}", controller_applet_version, controller_private_arg.arg_size);
            ASSERT(user_arg.size() >= sizeof(ControllerSupportArgNew));
